...
## Data Safety form
See `store/app-privacy-answers.md` for the exact answers to enter into the Data Safety section.

## Content rating questionnaire guidance
Target: **Everyone**
- No violence, sexual content, profanity
- No user-generated content, no chat/social features
- No gambling
- No drug/alcohol/tobacco references
- Health-related content is general guidance only, with an in-app medical disclaimer — answer the "references to health/medical topics" question honestly (yes, informational only, not diagnostic) if asked
...
- **Phone screenshots:** minimum 2, up to 8. Each side between 320–3840 px, 16:9 or 9:16 aspect ratio recommended (e.g. 1080 × 1920 px)
- **App icon:** 512 × 512 px, 32-bit PNG with alpha
- No tablet/Chromebook screenshots required unless you later enable tablet support
